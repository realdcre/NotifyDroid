...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555146, ; uint32_t android_runtime_jnienv_class_token (0x20002ca)
	i32 100670698, ; uint32_t jnienv_initialize_method_token (0x6001cea)
	i32 100670697, ; uint32_t jnienv_registerjninatives_method_token (0x6001ce9)
...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-Xamarin.AndroidX.Browser.dll.so
		ptr null; void* handle (0x0)
	}, ; 47
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.45_name, ; name: libaot-Xamarin.AndroidX.VersionedParcelable.dll.so
		ptr null; void* handle (0x0)
	}, ; 94
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8513291594412650164, ; hash 0x762549998a48eeb4, from name: notifyd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 208
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10027810271339700311, ; hash 0x8b29f04fea376057, from name: aot-notifyd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 256
	...
	%struct.DSOCacheEntry {
		i64 12996114814729028689, ; hash 0xb45b7991501d8451, from name: aot-notifyd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 338
	...
	%struct.DSOCacheEntry {
		i64 13853130769508580542, ; hash 0xc0403509af97bcbe, from name: libaot-notifyd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 14429374266481434095, ; hash 0xc83f6f71fcc9ddef, from name: notifyd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 387
	...
	%struct.DSOCacheEntry {
		i64 18431897667808065838, ; hash 0xffcb4145c20cf92e, from name: libaot-notifyd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 490
...
@.env.3 = private unnamed_addr constant [37 x i8] c"81a2c372-3893-42ce-bb9b-97073e62e936\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.ldnxdevllc.notifydroidA\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-notifyd.dll.so\00", align 16
...
@.DSOCacheEntry.24_name = private unnamed_addr constant [39 x i8] c"libaot-Xamarin.AndroidX.Browser.dll.so\00", align 16
...
@.DSOCacheEntry.45_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 16
