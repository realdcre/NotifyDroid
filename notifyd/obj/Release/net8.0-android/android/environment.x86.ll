...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 548111172, ; hash 0x20ab8344, from name: aot-notifyd
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 782051976, ; hash 0x2e9d2a88, from name: notifyd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 78
	...
	%struct.DSOCacheEntry {
		i64 1723236750, ; hash 0x66b6818e, from name: libaot-notifyd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 182
	...
	%struct.DSOCacheEntry {
		i64 2328690344, ; hash 0x8accfea8, from name: notifyd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 262
	...
	%struct.DSOCacheEntry {
		i64 3661633428, ; hash 0xda401794, from name: libaot-notifyd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 423
	...
	%struct.DSOCacheEntry {
		i64 4228907548, ; hash 0xfc10021c, from name: aot-notifyd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-notifyd.dll.so
		ptr null; void* handle (0x0)
	}, ; 486
